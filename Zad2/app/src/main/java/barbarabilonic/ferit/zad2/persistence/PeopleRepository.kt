...
object PeopleRepository {
    private val people= mutableListOf<InspiringPearson>(
        InspiringPearson(
            ...
            listOf("We cannot solve our problems with the same thinking we used when we created them.","Imagination is more important than knowledge."),
        ...
        InspiringPearson(
            ...
            listOf("One must be sane to think clearly, but one can think deeply and be quite insane.","The present is theirs; the future, for which I really worked, is mine."),
